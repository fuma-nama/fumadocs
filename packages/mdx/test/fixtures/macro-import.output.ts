...
export const blog = await __fdm.docAsync({ base: "test/fixtures/generate-index", head: {"index.mdx": __fd_glob_3, "folder/test.mdx": __fd_glob_4, }, body: {"index.mdx": () => import("../generate-index/index.mdx?macro_id=test%2Ffixtures%2Fmacro%2Fsource.ts%23blog"), "folder/test.mdx": () => import("../generate-index/folder/test.mdx?macro_id=test%2Ffixtures%2Fmacro%2Fsource.ts%23blog"), } });
