...
import { type JsonSchema, stringify } from '@fumadocs/json-schema';
...
export function ObjectInput({
  ...
  const {
    ...
    /** render the fields only when expanded, defaults to objects with over 100 properties */
    ...
    return (
      ...
      >
        <div className={fieldLabelVariants()}>
          ...
          {slotType ?? <FieldLabelType>{stringify(field)}</FieldLabelType>}
          {toolbar}
