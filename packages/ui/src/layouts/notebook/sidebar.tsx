...
export function SidebarContent(props: ComponentProps<'aside'>) {
  ...
  return (
    <aside
      ...
      className={cn(
        'sticky [grid-area:sidebar] w-(--fd-sidebar-width) flex flex-col top-(--fd-sidebar-top) h-[calc(100vh-var(--fd-sidebar-top))] z-20 bg-fd-card text-sm border-e transition-[top,opacity,translate,width] duration-200 max-md:hidden',
        collapsed && [
