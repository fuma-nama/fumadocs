...
export function TabsList(props: React.ComponentProps<typeof Unstyled.TabsList>) {
  return (
    <Unstyled.TabsList
      {...props}
      className={cn(
...
export function TabsTrigger(props: React.ComponentProps<typeof Unstyled.TabsTrigger>) {
  return (
