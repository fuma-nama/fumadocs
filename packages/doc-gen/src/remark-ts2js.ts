...
export function remarkTypeScriptToJavaScriptSatteri(options: TypeScriptToJavaScriptOptions = {}) {
  const { persist = false, defaultValue = 'ts', disableTrigger = false } = options;
