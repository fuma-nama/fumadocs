...
import type { ReplaceReactNode } from '@/controls/generate';
...
export interface StoryOptions<C extends FC<any>> {
  ...
  /**
   * Controls & data generated at build time by `@fumadocs/story/vite`.
   *
   * @internal
   */
  _generated?: {
        ...
        return {
          ...
          presets: normalized.map((preset) => {
            ...
            if (preset.controls && 'node' in preset.controls) {
              ...
              throw new Error(
                `[@fumadocs/story] No generated data for story, make sure the Vite plugin is configured correctly`,
              );
            }
