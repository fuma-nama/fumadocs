...
<APIPlayground authorization={{"type":"string","name":"authorization","defaultValue":"Basic","isRequired":true,"description":"The authorization token"}} method={"GET"} route={"/tickets/{ticketId}/qr"} path={[{"name":"ticketId","type":"string","defaultValue":"a54a57ca-36f8-421b-a6b4-2e8f26858a4c","isRequired":true}]} query={[]} header={[]} body={undefined} schemas={{}}>
