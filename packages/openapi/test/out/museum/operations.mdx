...
<APIPlayground authorization={{"type":"string","name":"authorization","defaultValue":"Bearer","isRequired":true,"description":"The authorization token"}} method={"GET"} route={"/museum-hours"} path={[]} query={[{"type":"string","defaultValue":"2023-02-23","isRequired":false,"name":"startDate"},{"type":"number","defaultValue":2,"isRequired":false,"name":"page"},{"type":"number","defaultValue":15,"isRequired":false,"name":"limit"}]} header={[]} body={undefined}>
