...
<OpenAPIPage document={"petstore"} webhooks={[]} operations={[{"path":"/pets","method":"get"},{"path":"/pets","method":"post"},{"path":"/pets/{petId}","method":"get"}]} showTitle />
```