...
<APIPlayground authorization={{"type":"string","name":"authorization","defaultValue":"Bearer","isRequired":true,"description":"The authorization token"}} method={"GET"} route={"/v1/apis.getApi"} path={[]} query={[{"type":"string","defaultValue":"api_1234","isRequired":true,"name":"apiId","description":"The id of the api to fetch"}]} header={[]} body={undefined}>
...
<APIPlayground authorization={{"type":"string","name":"authorization","defaultValue":"Bearer","isRequired":true,"description":"The authorization token"}} method={"GET"} route={"/v1/apis.listKeys"} path={[]} query={[{"type":"string","defaultValue":"api_1234","isRequired":true,"name":"apiId","description":"The id of the api to fetch"},{"type":"number","defaultValue":100,"isRequired":false,"name":"limit","description":"The maximum number of keys to return"},{"type":"string","defaultValue":"","isRequired":false,"name":"cursor","description":"Use this to fetch the next page of results. A new cursor will be returned in the response if there are more results."},{"type":"string","defaultValue":"","isRequired":false,"name":"ownerId","description":"If provided, this will only return keys where the `ownerId` matches."},{"type":"boolean","defaultValue":"","isRequired":false,"name":"decrypt","description":"Decrypt and display the raw key. Only possible if the key was encrypted when generated."}]} header={[]} body={undefined}>
...
```bash
curl -X GET "https://api.unkey.dev/v1/apis.listKeys?apiId=api_1234&limit=100&cursor=string&ownerId=string&decrypt=true"
```
...
```js
fetch("https://api.unkey.dev/v1/apis.listKeys?apiId=api_1234&limit=100&cursor=string&ownerId=string&decrypt=true", {
  method: "GET"
});
```
...
<APIPlayground authorization={{"type":"string","name":"authorization","defaultValue":"Bearer","isRequired":true,"description":"The authorization token"}} method={"POST"} route={"/v1/apis.deleteKeys"} path={[]} query={[]} header={[]} body={{"type":"object","isRequired":false,"name":"body","properties":[{"type":"string","defaultValue":"api_1234","isRequired":true,"name":"apiId","description":"The id of the api, that the keys belong to."},{"type":"boolean","defaultValue":"","isRequired":false,"name":"permanent","description":"If true, the keys will be permanently deleted. If false, the keys will be soft-deleted and can be restored later. "}]}}>
