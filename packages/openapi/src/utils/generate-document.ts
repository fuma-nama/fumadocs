...
export function generateDocument(
  ...
  if (addGeneratedComment !== false) {
    let commentContent = "This file was auto-generated by Fuma Docs.\nDo not edit this file directly. Any changes should be made by running the generation command again.";
    
    if (typeof addGeneratedComment === 'string') {
      // Sanitize custom comment to remove special characters
      commentContent = addGeneratedComment.replace(/[:#\[\]{}]/g, '');
    }
    
    // Format as YAML comments at the top of the frontmatter
