...
Setup Tailwind CSS on your Next.js app, add the following to `global.css`.
...
You can use [Home Layout](/docs/ui/layouts/home-layout) for other pages of the site, it includes a navbar with theme toggle.
