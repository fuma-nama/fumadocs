...
<Accordions>
    ...
    <Accordion id='blog-usage' title="Can I use it for Blog?">
        ...
        You can use the `DocsBody` component to apply typography styles and leverage the built-in remark/rehype plugins.
        Besides, the `Layout` component allows you to share the navbar between other pages.
