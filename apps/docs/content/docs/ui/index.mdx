...
<Wrapper className="nd-not-prose p-0">
  <Image alt="Features" src={Features} />
</Wrapper>
...
```bash
npm install next-docs-ui next-docs-zeta
```

<h3>Configuration</h3>

Next Docs UI doesn't provide static generation directly. You can use a source
you prefer, such as [Contentlayer](https://www.contentlayer.dev) which is
supported by default. **This guide is written for Contentlayer.**
...
Follow their [Getting Started](https://contentlayer.dev/docs/getting-started)
guide to setup Contentlayer for Next.js Project.

After setting up Contentlayer, copy the default Contentlayer configuration.
...
<Accordion title="Root Layout">

```tsx title="app/layout.tsx"
|reference:../../examples/simple/app/layout.tsx|
```
