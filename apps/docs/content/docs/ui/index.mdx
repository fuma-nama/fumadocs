...
- `lib/source.ts`: Code for content source adapter, Fumadocs uses [`loader()`](/docs/headless/source-api) to interact with your content source, it also assign an url to your pages.
