...
It composes seamlessly into Next.js App Router, allowing high code flexibility.
...
The input/source of your content can be a CMS or local data layers like [Content Collections](https://www.content-collections.dev) and [Fumadocs MDX](/docs/mdx), the official content source.
...
- `lib/source.ts`: Code for content source adapter, Fumadocs uses [`loader()`](/docs/headless/source-api) to interact with your content source, it also assigns a URL to your pages.
