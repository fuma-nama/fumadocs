...
<h4 className="inline-flex items-center gap-2">
  <CpuIcon className="text-purple-300" />
  <span>Core</span>
</h4>
...
<h4 className="inline-flex items-center gap-2">
  <PanelsTopLeft className="text-blue-300" />
  <span>UI</span>
</h4>
...
Fumadocs focuses on docs authoring experience, it provides a beautiful theme and many docs automation tools.
...
You can build blog sites using Fumadocs.
Since Next.js is already a powerful framework, most features can be implemented with Next.js itself.
