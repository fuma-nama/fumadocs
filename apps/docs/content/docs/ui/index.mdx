...
Create a new app with `create-fuma-docs-app`.
...
<Accordions>
<Accordion title="Why Fumadocs UI?">
...
<Accordion id='collapsible-fix-error' title="How to fix 'supports-color' error?">
...
Open in [CodeSandbox](https://githubbox.com/fuma-nama/@fuma-docs/ui-template).
