...
<auto-type-table cwd path="content/docs/ui/props.ts" name="TOCProps" />
...
<auto-type-table cwd path="content/docs/ui/props.ts" name="FooterProps" />

### Breadcrumb

A navigation element, shown only when user is navigating in folders.

<auto-type-table cwd path="content/docs/ui/props.ts" name="BreadcrumbProps" />
