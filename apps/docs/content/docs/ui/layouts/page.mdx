...
| Style              | Description                                                                   |
| ------------------ | ----------------------------------------------------------------------------- |
| `normal` (default) | A track line with a thumb on active headings.                                 |
| `clerk`            | A track line following heading depth, inspired by [Clerk](https://clerk.com). |
| `block`            | No track line, a block slides behind active headings.                         |
