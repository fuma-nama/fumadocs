...
Fumadocs, unlike the other frameworks, expects you to write code and cooperate with other parts of your software.
...
You can’t control how they render the page or the internal logic.
...
**Opinionated on UI:** The only thing Fumadocs UI offers is **User Interface**, it is opinionated on UI for the best mobile responsiveness and user experience.
