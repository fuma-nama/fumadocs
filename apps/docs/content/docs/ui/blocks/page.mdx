...
<AutoTypeTable path="ui" name="PageProps" />
...
<AutoTypeTable path="ui" name="TOCProps" />
...
<AutoTypeTable path="ui" name="FooterProps" />

### Breadcrumb

<AutoTypeTable path="ui" name="BreadcrumbProps" />
