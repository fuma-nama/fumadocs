...
We have a built-in plugin based on [Tailwind CSS Typography](https://tailwindcss.com/docs/typography-plugin), you can customize it with CSS.

The Tailwind CSS plugin adds a `prose` class.
