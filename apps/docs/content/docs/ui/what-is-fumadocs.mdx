...
You are still using the features of Next.js App Router like **Static Site Generation**. There is nothing new for Next.js developers, that ou can use it with confidence.
