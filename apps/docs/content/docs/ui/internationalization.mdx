...
For Flexsearch, you don't need further changes if you're using the `createFromSource` shortcut. See [Search I18n](/docs/headless/search/flexsearch#internationalization).
