...
You can use `defineDocs` to define the required collection to work with Fumadocs.
...
Note that other type validators compatible to Standard Schema works as well.
