...
Alternatively, you can define collections in your app modules with the [Macro API](/docs/mdx/macro) (`fumadocs-mdx/macro`), and use them in place without generated entry files.
