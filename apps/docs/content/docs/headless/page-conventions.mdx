...
description: Customize generated page slugs and page tree.
---
...
Fumadocs UI renders a [dropdown](/docs/ui/layouts/docs#tabs-groups) for each root folder on the current page's path to switch between root folders of its type, see [Versioning](/docs/versioning) for a complete example.
