...
This is a shared convention for organizing your pages, should be followed by all built-in file-system based sources including Contentlayer and Next Docs MDX.
...
property to the frontmatter or meta, and configure icon handler with
the `resolveIcon` option provided by Source API.
