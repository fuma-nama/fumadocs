...
1. Sign up and obtain the required API keys for your search. Store these
   credentials in environment variables.

2. Create and sync your index with the `sync` function.
...
3. To search documents on the client side, you may use the search dialog
