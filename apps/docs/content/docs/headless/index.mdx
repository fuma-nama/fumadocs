...
We have native support for [Fumadocs MDX](/docs/mdx) and [Content Collections](/docs/headless/content-collections), but all formats and
content sources have be supported via a custom adapter.
