...
Create the search route handler.
...
For languages on the Orama [Supported Languages](https://docs.orama.com/open-source/supported-languages#officially-supported-languages) list:

<Tabs items={['Normal', 'Static Export']}>
...
Update your `initOrama` function.
...
If your language is not on the list, you will need some extra configurations:
