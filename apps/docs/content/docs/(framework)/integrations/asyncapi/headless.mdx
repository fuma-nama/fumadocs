...
Everything outside `@fumadocs/asyncapi/ui` is headless — the package entry gives you the state and logic of API pages, without UI:
...
'use client';
import { type CodeBlockProps, createAsyncAPIPage } from '@fumadocs/asyncapi';
