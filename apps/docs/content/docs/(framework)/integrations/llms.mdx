...
The Markdown of a single page, for AI agents. Pages are served under `/llms.mdx/docs/<slugs>/content.md`. The route prefix and the URL helpers of a page live in `lib/shared.ts`, so the URL layer stays yours.
