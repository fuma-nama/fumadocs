...
### Pick the Right Component [step]

For layout UIs, there's different built-in layout components you can try:
...
<Cards>
  ...
  <Card title="Flux Layout" href="/docs/ui/layouts/flux">
    An aggressively minimal layout for docs
  </Card>
  <Card title="Glass Layout" href="/docs/ui/layouts/glass">
