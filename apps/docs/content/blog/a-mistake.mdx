...
**For example:** A small CSS change can still break hacky CSS customisations. We can only ensure backward compatibility for the ones scoped by CSS selectors, or exposed options:
