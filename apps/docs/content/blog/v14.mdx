...
We **highly recommend** to use `createTypeTable` instead of referencing the component directly, this allows a single instance of TypeScript Compiler API to be shared.
