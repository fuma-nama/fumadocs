  ...
  return (
    ...
    >
      ...
      <DocsLayout
        ...
        nav={false}
        sidebarBanner={
          <div className="flex flex-row gap-2 items-center p-2 rounded-lg border bg-card text-card-foreground transition-colors shadow-lg shadow-background z-[2] hover:bg-accent">
