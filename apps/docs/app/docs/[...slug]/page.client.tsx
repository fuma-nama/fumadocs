...
const optionVariants = cva(
  'text-sm px-3 py-2.5 inline-flex items-center font-medium gap-2 hover:text-fd-accent-foreground hover:bg-fd-accent [&_svg]:size-4',
);

export function ViewOptions(props: { markdownUrl: string; githubUrl: string }) {
  const q = `Read ${props.markdownUrl}, I want to ask questions about it.`;
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="flex flex-col p-0 overflow-auto">
        <a
