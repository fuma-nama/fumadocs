  ...
  return (
    <main>
      <div className="absolute inset-x-0 top-0 h-[400px] w-full -translate-y-8 z-[-1]">
        <div className="h-full w-full mx-auto max-w-[1000px] bg-gradient-to-r from-purple-400 to-blue-400 [mask-image:radial-gradient(500px_100%_at_top_center,white,transparent)] opacity-50 animate-in fade-in duration-1000" />
      </div>
