export const GLSLX_SOURCE_FRAGMENT_SHADER =
...
export const GLSLX_SOURCE_VERTEX_SHADER =
  'precision highp float;attribute vec3 aPosition;void main(){gl_Position=vec4(aPosition,1.);}';
